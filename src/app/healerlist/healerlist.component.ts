...
@Component({
  selector: 'app-healerlist',
  templateUrl: './healerlist.component.html',
  styleUrls: ['./healerlist.component.css'],
    providers: [Commonservices],
})
export class HealerlistComponent implements OnInit {
    public fb;
    public datalist;
    public id;
    orderbyquery: any;
    ...
    admindel() {
        console.log('healerdel');
        this.isModalShown = false;
        console.log('id got' + this.id);
        let link = this.serverurl + 'deletehealer';
        let data = {id: this.id};
