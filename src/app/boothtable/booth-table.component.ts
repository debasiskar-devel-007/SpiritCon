...
@Component({
  selector: 'app-booth-table',
  templateUrl: './booth-table.component.html',
  styleUrls: ['./booth-table.component.css'],
    providers: [Commonservices],
})
export class BoothTableComponent implements OnInit {
    public boothlist;
    public healerlist;
    public serverurl;
    ...
    constructor(private _http: Http, private _commonservices: Commonservices, public _sanitizer: DomSanitizer, private router: Router, private readonly meta: MetaService) {
        ...
        this.meta.setTitle('SpiritCon - Booth Table');
        ...
        this.meta.setTag('og:title', 'SpiritCon - Booth Table');
        this.meta.setTag('twitter:title', 'SpiritCon - Booth Table');
